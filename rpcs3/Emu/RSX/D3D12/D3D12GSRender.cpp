...
extern const cfg::bool_entry g_cfg_rsx_vsync;
extern const cfg::bool_entry g_cfg_rsx_debug_output;
extern const cfg::bool_entry g_cfg_rsx_overlay;

const extern cfg::string_entry g_cfg_d3d12_adapter("rsx/d3d12/Adapter");
...
void D3D12GSRender::flip(int buffer)
{
	...
	CHECK_HRESULT(m_swap_chain->Present(g_cfg_rsx_vsync, 0));
